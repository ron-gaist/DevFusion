...
class LLMRequestMessage:
    ...
    prompt: str
    model_preferences: Optional[Dict[str, Any]] = None # e.g., {"provider": "ollama", "model": "llama3"}
...
class LLMResponseMessage:
    ...
    content: str
    metadata: Optional[Dict[str, Any]] = None # e.g., tokens_used, confidence, model_used
